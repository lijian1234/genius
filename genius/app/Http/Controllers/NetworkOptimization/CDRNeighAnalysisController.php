...
class CDRNeighAnalysisController extends Controller{
	...
	public function getCdrServeNeighDataHeader(){
		$dateTime = Input::get('dateTime');
	   	$dbname = 'CDR_20160627_0800_1100';
	    $dsn = "mysql:host=10.40.57.189;dbname=$dbname";
	...
	public function getCdrServeNeighDataHeaderBak(){
	   	$dbname = $this->getMRDatabase(Input::get('dataBase'));
	   	$dateTime = Input::get('dateTime');
	...
	public function getCdrServeNeighDataBak(){
	    $limit='';
	    $page = isset($_REQUEST['page']) ? intval($_REQUEST['page']) : 1;
	    $rows = isset($_REQUEST['limit']) ? intval($_REQUEST['limit']) : 50;
	    $offset = ($page-1)*$rows;
  	...
  	public function getAllCdrServeNeighDataBak(){
