			...
			<div class='box'>
				...
				<div class="input-group">
					...
					<!-- <div class="input-group">
						...
						<span class="input-group-btn">
							<button class="btn btn-primary" type="button" onClick="searchLTEQuery()">
								&nbsp;<span class="glyphicon glyphicon-search btn-group-lg" aria-hidden="true"></span>
							</button>
							<button class="btn btn-primary" type="button" onClick="clearLteQuery()">
								&nbsp;<span class="glyphicon glyphicon-remove btn-group-lg" aria-hidden="true"></span>
							</button>
						</span>
					</div> -->
		...
		<div class="col-sm-9">	
			<div class="box"> 
				<div class="box-header">
					<h3 class="box-title">查询条件</h3><!-- <input checked data-toggle="toggle" data-size="mini" type="checkbox"> -->
					...
					<div class="box-tools pull-right">
                        ...
                        <!-- <input checked data-toggle="toggle" data-size="mini" type="checkbox"> -->
                    </div>
				</div>
				<div class="box-body">      
					<!-- <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
						...
						<!-- <div style="text-align:right;">
							<a id="search" class="btn btn-primary ladda-button" data-color='red' data-style="expand-right" href="#" onClick="doSearchLTE('table')"><span class="ladda-label">查询</span></a>
							...
							<a id="export" class="btn btn-primary ladda-button" data-color='red' data-style="expand-right" href="#"  onClick="doSearchLTE('file')"><span class="ladda-label">导出</span></a> 
						</div> -->
				...
				<div class="box-footer" style="text-align:right;">
					<a id="search" class="btn btn-primary ladda-button" data-color='red' data-style="expand-right" href="#" onClick="doSearchLTE('table')"><span class="ladda-label">查询</span></a>
					<a id="save" class="btn btn-primary ladda-button" data-color='red' data-style="expand-right" href="#"  onClick="fileSave('file')"><span class="ladda-label">保存</span></a> 
					<a id="export" class="btn btn-primary ladda-button hidden" data-color='red' data-style="expand-right" href="#"  onClick="doSearchLTE('file')"><span class="ladda-label">导出</span></a> 
				</div>
			</div>
			<div class="box">
				<div class="box-header with-border">
