		...
		<div class="col-sm-9">
			<div class="box">
				...
				<div class="box-footer" style="text-align:right;">
					<a id="search" class="btn btn-primary ladda-button" data-color='red' data-style="expand-right" href="#" onClick="doSearchGSM('table')"><span class="ladda-label">查询</span></a>
					...
					<a id="export" class="btn btn-primary ladda-button hidden" data-color='red' data-style="expand-right" href="#"  onClick="doSearchGSM('file')"><span class="ladda-label">导出</span></a> 
				</div>
