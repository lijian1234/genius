			...
			<div class='box'>
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
                        <button type="button"  class="btn btn-box-tool" onClick="addMode()" title="新增模板"><i class="fa fa-file-o"></i></button>
                        <button type="button"  class="btn btn-box-tool"  onClick="deleteMode()" title="删除模板"><i class="fa fa-scissors"></i></button>
                        <button type="button"  class="btn btn-box-tool"  onClick="copyMode()" title="复制模板"><i class="fa fa-copy"></i></button>
                	</div>
				</div>
				<div class="box-body">
		...
		<div class="col-sm-3">	
			<div class="box"> 
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
                        <button type="button"  class="btn btn-box-tool" onClick="elementUp()" title="上移指标"><i class="fa fa-arrow-up"></i></button>
                        <button type="button"  class="btn btn-box-tool"  onClick="elementDown()" title="下移指标"><i class="fa fa-arrow-down"></i></button>
                        <button type="button"  class="btn btn-box-tool"  onClick="elementDelete()" title="删除指标"><i class="fa fa-scissors"></i></button>
                	</div>
				</div>
				<div class="box-body">
					<div class="form-group"  style="height:600px; overflow:auto;overflow-x:hidden">
		...
		<div class="col-sm-6">
			<div class='box'>
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
                        <button type="button"  class="btn btn-box-tool" onClick="addFormula()" title="新建公式"><i class="fa fa-file-o"></i></button>
                        <button type="button"  class="btn btn-box-tool"  onClick="deleteFormula()" title="删除公式"><i class="fa fa-scissors"></i></button>
                	</div>
				</div>
				<div class="box-body">
					...
					<br />
					<div class="form-group"  style="height:600px;width:100%; overflow:auto;margin-top:34px" id="NBIFormulaTableDiv">
...
<div class="modal fade" id="copy_mode">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="submit" name="submit" class="col-sm-2 col-sm-offset-4 btn btn-primary" onclick="updateModeCopy()">复制</button>
				<button type="button" class="col-sm-2 btn btn-default" id="cancelBtn" data-dismiss="modal">取消</button>
			</div>
			</form>
		</div>
