						...
						<div class="row">
							<form>
								<div class="form-group col-sm-4">
									<select id="allCity" multiple="multiple"  style='display:inline-block;'>
									</select>
								</div>
								...
								<!-- <a id="newBuild" class="btn btn-primary ladda-button" data-color='red' data-style="expand-right" href="#"  onClick="newBuild('file')"><span class="ladda-label">新建模板</span></a>  -->
							<!-- 	<a id="saveMode" class="btn btn-primary ladda-button" data-color='red' data-style="expand-right" href="#"  onClick="saveMode()"><span class="ladda-label">保存模板</span></a>  -->
								<!-- <a id="delete" class="btn btn-primary ladda-button" data-color='red' data-style="expand-right" href="#"  onClick="deleteMode('file')"><span class="ladda-label">删除模板</span></a>  -->
							</form>
						</div>
					</div>					
				</div>
