...
<div class="col-sm-12">
	<div class="box">
		...
		<div class='box-footer' style="text-align:right;">
			...
			<a id="export" class="btn btn-primary ladda-button" data-color='red'  data-style="expand-right" href="#"  onClick="exportAll()"><span class="ladda-label">导出全部</span></a>   <!-- data-toggle="tooltip" data-placement="bottom" title="导出所有数据" -->
		</div>	
	</div>
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title">查询数据</h3>
			<div class="box-tools pull-right"> <!--  data-toggle="tooltip" data-placement="left" title="保存查询内容" -->
